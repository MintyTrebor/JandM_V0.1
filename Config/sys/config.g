...
M550 P"Voron-V0"                               ; set printer name
...
M203 X12000.00 Y6000.00 Z900.00 E1200.00       ; set maximum speeds (mm/min)
M201 X2000.00 Y2000.00 Z45.00 E250.00          ; set accelerations (mm/s^2)
M906 X700 Y700 Z520 E800 I30                   ; set motor currents (mA) and motor idle factor in per cent
...
; Z-Probe
M558 P5 C"e1stop" H5 F120 T6000                          ; disable Z probe but set dive height, probe speed and travel speed
